...
test_that("idAssetGroup() works", {
  ...
  expect_equal(idAssetGroup("LCT TMC-3")               , "LCT")
  ...
  expect_equal(idAssetGroup("MOTORCYCLE")              , "MC")
  expect_equal(idAssetGroup("MOTORCYCLE-4")            , "MC")
  ...
  expect_equal(idAssetGroup("MOBILE CRUSH-1")          , "MOC")
  expect_equal(idAssetGroup("MOBILE CRUSR-1")          , "MOC")
  expect_equal(idAssetGroup("MOBILE CRUSER")           , "MOC")
  ...
  expect_equal(idAssetGroup("MTX-2 (MINI TX-2)")       , "MTX")
  ...
  expect_equal(idAssetGroup("SP-44 (COVID-19)")        , "SP")
  expect_equal(idAssetGroup("SP-63 NAC SUR")           , "SP")
  ...
  expect_equal(idAssetGroup("V-4")                     , "VC")
  ...
  expect_equal(idAssetGroup("WT 96")                   , "WT")
